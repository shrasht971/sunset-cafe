  ...
  return (
    <div className='h-fit pb-40 bg-menu1'>
      ...
      <img src={Starter} className='lg:h-[60vh] w-full h-[40vh] px-2 object-cover bg-no-repeat' />
        ...
        <div className="flex text-white lg:text-3xl text-xs  lg:font-semibold mt-4 mx-1  lg:tracking-widest w-full">
        <Link to='/chiense'>
          ...
          <p className="px-2 lg:px-5">SIDES</p>
          <p className="px-2 lg:px-5">SALADS</p>
          <p className="px-2 lg:px-5">DESSERTS/ICE-CREAM</p>
          <p className="px-2 lg:px-5 ">MAIN COURSE</p>
         ...
         <div className='lg:flex w-full mt-14 lg:pl-10'>
           <div className="flex flex-col lg:w-1/2 lg:pl-10  border-yellow-500  lg:border-r-2">
                 <p className='lg:text-3xl text-2xl font-semibold text-white lg:ml-20 ml-36'>STARTERS</p>
            ...
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2  mt-2 lg:mr-8 mx-2 rounded-lg ">
                <p className="text-5xl font-extrabold text-green-500 lg:mt-[-70%] mt-[-100%] text-center  ">
                  .
                </p>
              </div>
              <div >
        ...
        <div className="flex mt-8">
            ...
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2  mt-2 lg:mr-8 mx-2 rounded-lg">
                <p className="text-5xl font-extrabold text-green-500 mt-[-100%] lg:mt-[-70%] text-center">
                  .
                </p>
              </div>
              <div >
        ...
        <div className="flex mt-8">
            ...
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-red-700 border-2  mt-2 lg:mr-8 mx-2 rounded-lg">
                <p className="text-5xl font-extrabold text-red-700 mt-[-100%] lg:mt-[-70%] text-center">
                  .
                </p>
              </div>
              <div >
        ...
        <p className='lg:text-3xl text-2xl mt-4 text-center font-semibold text-white lg:ml-20'>MOUTHWATERING COMBOS</p>
        <div className="flex mt-6 lg:mt-16">
            <div className="text-white lg:text-xl font-semibold ml-4 w-72 lg:w-96 tracking-widest" >
            VEGETARIAN PLATTER
            <p className="text-yellow-300 font-bold">149/-</p>
            </div>
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2  mt-2 mr-8 mx-2 rounded-lg">
                <p className="text-5xl font-extrabold text-green-500 mt-[-100%] lg:mt-[-70%] text-center">
                  .
                </p>
              </div>
