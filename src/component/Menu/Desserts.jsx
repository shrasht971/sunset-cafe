...
const Desserts = () =>{
    return(
        ...
        <div className="flex text-white xs:text-[2.7vw] xs:fontbold text-xs font-extralight md:text-xl md:font-semibold lg:text-3xl lg:font-semibold mt-4 mx-1 lg:tracking-widest w-full">
          ...
          <Link to='/salads'>
            <p className="px-1 md:px-3 lg:px-14">SALADS</p>
            </Link>
            <Link to='/desserts'> 
            <p className="px-2 md:px-3 lg:px-14">DESSERTS/ICE-CREAM</p>
            </Link> 
            <Link to='/mainCourse'>
          ...
          <p className='lg:text-3xl xs:text-xs md:text-xl md:font-semibold font-bold text-white text-center lg:ml-20 mt-8'>DESSERTS</p>
          ...
          <p className='lg:text-3xl xs:text-xs md:text-xl md:font-semibold font-bold text-white text-center lg:ml-20 mt-8'>DESSERTS & SUNDAES</p>
