...
import Sandwiches1 from '../../assets/image/sandwiches1.png'
import Sandwiches2 from '../../assets/image/sandwiches2.png'
import Sandwiches3 from '../../assets/image/sandwiches3.png'
import Sandwiches4 from '../../assets/image/sandwiches4.png'
import Sandwiches5 from '../../assets/image/sandwiches5.png'
import Sandwiches6 from '../../assets/image/sandwiches6.png'
...
const BSMenu = () => {
  ...
  return (
    <div className="h-fit pb-40 bg-menu-bgcolor ">
      <div className=" w-full relative top-32">
        <div className="container w-full">
          <img
            src={Menu1}
            className="lg:h-[500px]  w-[100%] px-2 object-cover bg-no-repeat "
          />
        </div>
        ...
        <div className="lg:flex  w-full mt-10 pl-10">
          <div className="flex flex-col sm:w-full lg:w-1/2 ">
            <div className="flex bg-welcome rounded-2xl w-52 lg:w-80 lg:ml-20 lg:pl-6  lg:mr-96 lg:py-2 ">
              <div className="lg:text-3xl text-xl font-semibold text-white  ml-4 mr-8 tracking-wider">
                BURGERS
              </div>
              ...
              <p className=" text-3xl  lg:text-5xl font-extralight mt-[-2%] lg:mt-[-8px] lg:mx-1 text-slate-200">
                /
              </p>
            ...
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2 mr-2 rounded-lg mt-7">
                <p className="text-5xl font-extrabold text-green-500  lg:mt-[-24px] xs:mt-[-140%] sm:mt-[-120%] text-center   ">
                  .
                </p>
              </div>
              <div >
            ...
            <img src={Burger2} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className="flex border-yellow-500   lg:border-r-2">
            <div className="text-white lg:text-xl font-semibold lg:ml-14 mt-6 w-80 tracking-widest" >
            Aloo Tikki Burger
            <p className="text-yellow-300 font-bold">149/-</p>
            </div>
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2 mr-2 rounded-lg mt-7">
                <p className="text-5xl font-extrabold text-green-500 xs:mt-[-140%]  sm:mt-[-120%] lg:mt-[-24px] text-center   ">
                  .
                </p>
              </div>
              <div >
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2 mt-6  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Burger3} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className="flex border-yellow-500  border-r-2">
            <div className="text-white lg:text-xl font-semibold lg:ml-14 w-72 mr-8 tracking-widest mt-8" >
            Egg Bhurji Breakfast Burger
            <p className="text-yellow-300 font-bold">129/-</p>
            </div>
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-red-700 border-2 mr-2 rounded-lg mt-7">
                <p className="text-5xl font-extrabold text-red-700 xs:mt-[-140%] sm:mt-[-120%] lg:mt-[-24px] text-center   ">
                  .
                </p>
              </div>
              <div >
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2 mt-5  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Burger4} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className="flex  border-yellow-500  border-r-2 ">
            <div className="text-white lg:text-xl font-semibold lg:ml-14 w-80 tracking-widest mt-8" >
             Keema Pav Burger
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2 mt-5  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Burger5} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2  mx-4 rounded-lg mt-6 ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Burger6} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
          ...
          <div className="flex flex-col  lg:w-1/2 mt-4">
            <div className="flex bg-welcome h-10  xs:w-60 sm:w-56 xs:pl-4 lg:w-96 lg:h-14 rounded-2xl lg:ml-20 lg:pl-6  pl-2 lg:py-2 ">
              <div className="lg:text-3xl text-xl font-semibold text-white mr-2 tracking-wider">
                SANDWICHES
              </div>
              <div className="place-content-center  lg:w-8 lg:h-8 w-6 h-6 lg:ml-6  bg-slate-300 border-green-500 border-2  mt-1  rounded-lg">
                <p className="text-4xl font-extrabold text-green-500 lg:mt-[-16px] mt-[-98%] lg:ml-2 ml-1   ">
                  .
                </p>
              </div>

              <p className="lg:text-5xl text-3xl font-extralight mt-[-4px] lg:mx-1 lg:mt-[-8px] text-slate-200">
                /
              </p>
            ...
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2 mr-2 rounded-lg mt-1">
                <p className="text-5xl font-extrabold text-green-500 xs:mt-[-130%] sm:mt-[-120%] lg:mt-[-24px] text-center">
                  .
                </p>
              </div>
              <div >
              <p className=" bg-slate-300 lg:px-1 lg:py-2 lg:rounded-full lg:text-center min-[320px]:display:none max-[425px]:display:block ic">- 1 +</p>
            </div>
            <div className=" bg-red-400  text-center  w-24 h-12 py-2  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid ">
            <img src={Sandwiches1} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className="place-content-center w-8 h-6 lg:w-10 lg:h-8 bg-slate-300 border-green-500 border-2 mr-2 rounded-lg mt-7">
                <p className="text-5xl font-extrabold text-green-500  lg:mt-[-24px] xs:mt-[-130%] sm:mt-[-120%] text-center ">
                  .
                </p>
              </div>
              <div >
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2  mx-4 rounded-lg mt-6 ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Sandwiches2} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2 mt-6  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Sandwiches3} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2 mt-5  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Sandwiches4} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2 mt-5  mx-4 rounded-lg ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Sandwiches5} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
            ...
            <div className=" bg-red-400  text-center  w-24 h-12 py-2  mx-4 rounded-lg mt-6 ic"><p className="text-2xl text-white font-bold ">ADD +</p></div>
            <div className="mr-4 hid mt-6">
            <img src={Sandwiches6} className="w-20 h-14  "/>
            <div className="bg-slate-100 w-10 h-4 ml-4 text-xs mt-[-4%]  rounded-lg ">
            <p className=" bg-shadow text-center">- 1 +</p>
            </div>
            </div>
